...
def main():
    ...
    # Example 1: Simple sync streaming without tools
    print("1. Simple sync streaming without tools:")
    ...
    # Example 2: Sync streaming with tools
    print("2. Sync streaming with tools:")
    ...
    # Example 3: Sync streaming with parallel tool execution
    print("3. Sync streaming with parallel tool execution:")
