...
from typing import Any, List, Dict, overload, Iterable, AsyncIterator, Optional, Iterator
...
class MessagesWrapper(ExecutorMixin):
    ...
    def create(self, **kwargs: Any):
        ...
        Args:
            ...
            Returns:
                Message | str | Iterable[RawMessageStreamEvent] 
        """
...
class AsyncMessagesWrapper(ExecutorMixin):
    ...
    async def create(self, **kwargs: Any):
        ...
        Returns:
            Message | str | AsyncIterator[RawMessageStreamEvent]: Complete response or async stream based on stream parameter
        """
