...
"""
from typing import Any, Dict, List, AsyncIterator, Union, Callable, Optional, Iterable, Literal
...
class BetaCompletionsAsyncWrapper:
    ...
    async def parse(
        ...
        *,
        ...
        """
        Async wrapper over the `client.beta.chat.completions.parse()` method that provides richer integrations with Python specific types
